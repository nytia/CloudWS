...
//                con.close();
    ...
    public static Enchere selectEnchereByIdUser(String idutilisateur) throws Exception {
        Connection con= Conexion.getCo();
        Statement sta = con.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
        String req = "select * from enchere where idutilisateur="+idutilisateur;
        ResultSet res = sta.executeQuery(req);
        Enchere liste = null;
        try {
            ...
            res.beforeFirst();
            while (res.next()) {
                liste=new Enchere(res.getInt(1),res.getString(2),res.getString(3),res.getInt(4),res.getString(5),res.getDouble(6),res.getInt(7), res.getInt(8), res.getInt(9),res.getString(10));
            }
        } catch (Exception e) {
            throw e;
        } finally {
    ...
    public static Vector<Enchere> rechercheEnchere(Critere c) throws Exception {
        ...
        try {
            ...
            res.beforeFirst();
            while (res.next()) {
                listeRecherche.add(new Enchere(res.getInt(1),res.getString(2),res.getString(3),res.getInt(4),res.getString(5),res.getDouble(6),res.getInt(7), res.getInt(8), res.getInt(9) , res.getString(10)));
            }
        } catch (Exception e) {
            throw e;
        } finally {
